...
lazy val input = project.settings(
  commonSettings,
  libraryDependencies += "com.typesafe.play" %% "play-ahc-ws" % "2.8.13",
  publish / skip := true
)

lazy val output = project.settings(
  commonSettings,
  libraryDependencies += "com.typesafe.play" %% "play-ahc-ws-standalone" % "2.1.7",
  libraryDependencies += "com.typesafe.play" %% "play-ws-standalone-json" % "2.1.7",
  libraryDependencies += "com.typesafe.play" %% "play-ws-standalone-xml" % "2.1.7",
  publish / skip := true
)
